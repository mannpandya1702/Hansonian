    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto bg-[#faf9f7] min-h-screen space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-[#e8e4dd] p-5 space-y-4">
        ...
        {showAdvanced && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
            ...
            <p className="col-span-full text-xs text-[#4a4a6a]">
              When coordinates are provided, the nearest available staff member will be selected.
            </p>
          </div>
        )}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
        {filteredAgents.map(agent => (
          <div
            key={agent.id}
            className="bg-white rounded-2xl p-5 border border-[#e8e4dd] hover:shadow-md transition"
          >
