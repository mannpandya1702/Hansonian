...
const alertsData = [
  {
    ...
    severity: "high",
    zone: "Zone 4",
    description: "Medication non-compliance reported in 3 consecutive sessions.",
  ...
  },
  {
    ...
    severity: "medium",
    zone: "Zone 2",
    description: "Overtime hours exceeded threshold for 4 staff members this month.",
  ...
  },
  {
    ...
    severity: "low",
    zone: "Zone 1",
    description: "8 sessions missing mandatory progress documentation.",
    trend: "DEX risk +6%",
  },
]
    ...
    <>
      ...
      <section className="bg-white rounded-2xl border border-[#e8e4dd] p-4 sm:p-6 md:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          <InsightCard title="Revenue Forecast" description="Projected 8% revenue growth next quarter based on current trend velocity." impact="Positive" />
          <InsightCard title="Compliance Risk Alert" description="If missing session documentation exceeds 25, DEX score may drop below 4.0." impact="Warning" />
          <InsightCard title="Labor Cost Optimization" description="Reducing overtime in Zone 2 could improve net margin by 2.4%." impact="Action Required" />
        </div>
      </section>
    </>
  )
