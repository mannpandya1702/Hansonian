...
// ── US.M4: Incident Reporting + Photo Upload ──────────────────────────────────
// M3-S13: Caregiver submits an incident report with optional photo evidence.
...
class _IncidentsScreenState extends State<IncidentsScreen> {
  ...
  Future<void> _submit() async {
    ...
    await Future.delayed(const Duration(milliseconds: 700)); // TODO: POST to data-connector /incidents
    // Critical incidents automatically notify admin (backend handles this)
    setState(() { _saving = false; _submitted = true; });
    _titleCtrl.clear();
    _detailCtrl.clear();
    setState(() { _photo = null; _severity = IncidentSeverity.medium; });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Report Incident', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600)),
      ),
                ...
                Container(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: Text(
                      ...
                      style: const TextStyle(fontSize: 13, color: _critical, fontWeight: FontWeight.w500),
                    )),
                  ]),
                ),
