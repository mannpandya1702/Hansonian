...
const NAV_ITEMS = [
  { label: "Dashboard",        path: "/admin",               icon: HomeIcon,   description: "Financial pulse overview" },
  { label: "DEX Compliance",   path: "/admin/dex",           icon: ShieldIcon, description: "Reporting tracker" },
  { label: "Strategic Alerts", path: "/admin/alerts",        icon: BellIcon,   description: "Risk & incident feed" },
  { label: "Non-Compliant",    path: "/admin/non-compliant", icon: AlertIcon,  description: "Session issues" },
];
